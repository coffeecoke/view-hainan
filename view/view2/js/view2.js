...
var renderCompanyData = function(code) {
    var configs ={
        "01":[
            ...
            {name :"信用风险(45%)", key:"cRisk",  width : "10%", class:"blue", class:"level"},
            {name :"操作风险(10%)", key:"orisk",  width : "10%", class:"blue", class:"level"},
            {name :"管理风险(20%)", key:"mrisk",  width : "10%", class:"blue", class:"level"},
            {name :"经营风险(25%)", key:"brisk",  width : "10%", class:"blue", class:"level"},
        ],
        "02":[
            {name :"序号", key:"rank",  width : "5%", class:"rank"},
            {name :"企业名称", key:"companyName",  width : "25%", class:"white"},
            {name :"所属区域", key:"region",  width : "10%", class:"blue"},
            {name :"指数", key:"index",  width : "10%", class:"blue"},
            {name :"资产质量(20%)", key:"quality",  width : "10%", class:"blue", class:"level"},
            {name :"流动性(20%)", key:"fluidity",  width : "10%", class:"blue", class:"level"},
            {name :"盈利及效率(20%)", key:"profit",  width : "10%", class:"blue", class:"level"},
            {name :"管理风险(20%)", key:"mrisk",  width : "10%", class:"blue", class:"level"},
            {name :"经营风险(20%)", key:"brisk",  width : "10%", class:"blue", class:"level"},
        ],
        "03":[
            {name :"序号", key:"rank",  width : "5%", class:"rank"},
            {name :"企业名称", key:"companyName",  width : "25%", class:"white"},
            {name :"所属区域", key:"region",  width : "10%", class:"blue"},
            {name :"指数", key:"index",  width : "10%", class:"blue"},
            {name :"信用风险(19%)", key:"cRisk",  width : "10%", class:"blue", class:"level"},
            {name :"合规风险(23%)", key:"orisk",  width : "10%", class:"blue", class:"level"},
            {name :"管理风险(26%)", key:"mrisk",  width : "10%", class:"blue", class:"level"},
            {name :"经营风险(32%)", key:"brisk",  width : "10%", class:"blue", class:"level"},
        ],
        "04":[
            {name :"序号", key:"rank",  width : "5%", class:"rank"},
            {name :"企业名称", key:"companyName",  width : "25%", class:"white"},
