	        ...
	        itemStyle: {                // 折线拐点标志的样式。
	            normal: {               // 普通状态时的样式
	                lineStyle: {
                        ...
                        color: '#2d66d1',
                        shadowBlur: 30,
                        shadowColor: '#2278ff', //"#7498CE", //7498CE
                        shadowOffsetX: 0,
                        shadowOffsetY: 0
	                },
	                opacity: 1
...
var tableConfig = [
    {name :"时间", key:"date",  width : "8%"},
    {name :"金融机构名称", key:"orgName",  width : "23%"},
    {name :"合同金额（千万）", key:"contractAmount",  width : "10%"},
    {name :"项目期限", key:"projectDuration",  width : "5%"},
    {name :"借款利率", key:"lendingRate",  width : "5%"},
    {name :"起息日", key:"valueDateate",  width : "8%"},
    {name :"还款方式", key:"paymentType",  width : "8%"},
    {name :"担保方式", key:"guaranteeType",  width : "6%"},
    {name :"借款人", key:"borrowerName",  width : "5%"},
    {name :"借款人证件类型", key:"credentialType",  width : "10%"},
    {name :"借款人证件号码", key:"credentialNum",  width : "14%"}
];
...
var renderFrame = function() {
    ...
    renderTitle("#raderMap .origin-border", "舆情数据地区分布");
    // 行业指标变化分为上边图例和下边的图表
    renderTitle("#industryData .origin-border", "舆情数据行业分布");
    // 右侧表格
