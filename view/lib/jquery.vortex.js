	...
	var Vortex = function(element, options) {
		...
		kids
				.each(function(i) {
					...
					var resizeFactor = (1 + radiantVariable)/1.5;

					var newWidth = originalKidsSize[i].width * resizeFactor/1.5;
					var newHeight = originalKidsSize[i].height * resizeFactor/1.5;
		...
		this.start = function(repetitions) {
			...
			var startAnimation = function(kid, kidIndex) {
				...
				var newWidth = originalKidsSize[kidIndex].width * resizeFactor/1.5;
				
				
				var newHeight = originalKidsSize[kidIndex].height * resizeFactor/1.5;
